...
const vaults: VaultConfig[] = [
  {
    ...
    stakeToken: tokens.digichain,
    token: tokens.digichain,
  ...
  },
  {
    ...
    stakeToken: tokens.digichainBnb,
    token: tokens.digichain,
    quoteToken: tokens.wbnb,
    rewardToken: tokens.digichainBnb,
    platform: 'ApeSwap',
    masterchef: {
      pid: {
        [ChainId.BSC]: 1,
  ...
  // DIGICHAIN - BUSD Vault config
  {
    ...
    stakeToken: tokens.digichainBusd,
    token: tokens.digichain,
    quoteToken: tokens.wbnb,
    rewardToken: tokens.digichainBusd,
    platform: 'ApeSwap',
    masterchef: {
      pid: {
        [ChainId.BSC]: 2,
